...
-->
    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li class="current_page_item"><a href="purchase1.jsp" class="style1 style2">Quotation</a></li>
		<li><a href="po.jsp" class="style3">Purchase Order</a></li>
		</ul>
      </div> 
        	<div id="content">
            <div class="post">
            <h2 class="title"><strong>Quotation</strong></h2>
           <div class="entry">
            <input name="v1" type="button" value="CREATE"  onClick="document.location.href='purquo1.jsp'">
