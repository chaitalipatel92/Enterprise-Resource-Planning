...
<div class="menu_body"> <a href="ware1.jsp">All Product detail</a> <a href="saled_products.jsp">Saled Product</a> <a href="purchased_products.jsp">Purchased product</a> </div>
            ...
            <h2 class="title"><span class="style19">suppliers</span></h2>
            <br>
            <div class="entry">
                <input name="v1" type="button" value="ADD NEW SUPPLIER" onClick="document.location.href='supp_add.jsp'">
            </div>
            <br><br>
...
<strong>
 <%
                     ...
                     out.print("<table border =1 width ='90%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
                         ...
                         out.print("<th>Id</th> <th>Supplier Name </th><th></th><th></th><th></th>");
                         
                        out.print ("</tr>");
                        while(rs.next())
                                                       {
                            out.print("<tr align = 'center'>");
                            String sid = rs.getString("sup_id");
                            out.print("<td>"+ sid + "</td>");
                            out.print("<td>"+ rs.getString("s_name") + "</td>");
                            out.print("<td width = '100'> <a href ='s_viewDetail.jsp?x="+ sid +"'>fullDetail</a></td>");
                            out.print("<td width = '100'> <a href ='s_deleteData.jsp?x="+ sid +"'>Delete</a></td>");
                            out.print("<td width = '100'> <a href ='s_editData.jsp?x="+ sid +"'>Edit</a></td>");
                            out.print("</tr>");
