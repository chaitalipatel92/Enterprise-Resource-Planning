...
-->
    ...
    <br>
		...
		<li class="current_page_item"><a href="w_purchased_products.jsp" class="style3">Purchased Products History</a></li>
            ...
            <div class="post">
            <br>
            <h2 class="title"><span class="style19"><a href="w_purchased_products.jsp" class="style5"><u>purchased products</u></a>/<span class="style21 style16">details</span></span></h2>
<div class="entry">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
