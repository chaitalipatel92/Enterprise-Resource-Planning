...
-->
	...
	<div id="header">
		<div id="menu">
			<ul>
                 ...
                 <li><a href="warehouseman_security.jsp"><strong>SECURITY SETTINGS</strong></a></li>
    ...
    <br>
        ...
        <div id="cssmenu">
		<ul>
                <li class="current_page_item"><a href="warehouseman.jsp" class="style1 style2">All Products History</a></li>
		...
		<li><a href="w_purchased_products.jsp" class="style3">Purchased Products History</a></li>
            ...
            <div class="post">
            <br>
            <h2 class="title style9"><em><strong>PRODUCTS</strong></em></h2>
            <div class="entry"></div>
...
<strong>
 <%
                     ...
                     out.print("<table border =1 width ='90%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
                         ...
                         out.print("<th>Product Name </th><th>Available Quantity</th>");
