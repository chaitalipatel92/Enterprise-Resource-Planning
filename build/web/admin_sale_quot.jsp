    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li><a href="admin_sale_order.jsp" class="style3">Sales Orders</a></li>
            ...
            <h2 class="title"><span class="style19">Quotations</span></h2>
            <br>
            <br>
...
<strong>
 <%
                     ...
                     cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/home?zeroDateTimeBehavior=convertToNull","root","");
                     st  = cn.createStatement();
                     rs = st.executeQuery("select distinct username from s_quotation");
                     out.print("<table border =1 width ='90%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
                        ...
                        while(rs.next())
                            ...
                            out.print("<td width = '100'> <a href ='quot_viewDetail.jsp?x="+ user +"'>fullDetail</a></td>");
                            out.print("<td width = '100'> <a href ='quot_deleteData.jsp?x="+ user +"'>Delete</a></td>");
                            out.print("</tr>");
