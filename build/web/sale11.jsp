...
<strong>
        ...
        try
                     ...
                     cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/home?zeroDateTimeBehavior=convertToNull","root","");
                     st  = cn.createStatement();
                     String c,co,ad,w,d,p,m,dob,e,in,s2,b1,b2,b3,b4,b5;
                     ...
                     response.sendRedirect("sale111.jsp");
                     }
                     else
                     {
...
<tr>
  ...
  <table width="810" height="365" border="0" cellpadding="5" bgcolor="#CCCCCC">
              ...
              <td>&nbsp;</td>
                ...
                <td class="style9">DOB:</td>
                <td><input type="text" name="t10" value="" class="tcal" size="32" /></td>
              </tr>
              <tr>
