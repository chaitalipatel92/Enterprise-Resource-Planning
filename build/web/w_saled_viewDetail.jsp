...
-->
    ...
    <br>
		...
		<ul>
                ...
                <li class="current_page_item"><a href="w_saled_products.jsp" class="style1 style2">Saled Products History</a></li>
		<li><a href="w_purchased_products.jsp" class="style3">Purchased Products History</a></li>
            ...
            <div class="post">
            <br>
            <h2 class="title"><span class="style19"><a href="w_saled_products.jsp" class="style5"><u>Saled products</u></a>/<span class="style21 style16">details</span></span></h2>
<div class="entry">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          try
                     ...
                     cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/home?zeroDateTimeBehavior=convertToNull","root","");
                     st  = cn.createStatement();
                     rs = st.executeQuery("select * from s_order where prod_name = '"+ pname +"'");
                     ...
                     out.print("<table border =1 width ='100%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
						...
						out.print("<th colspan=3 align = 'center'>Product &nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp "+pname+" </th>");
                         ...
                         out.print("<th>Date</th><th>Customer Name</th><th>quantity</th>");
