    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li class="current_page_item"><a href="salesorder.jsp" class="style4">Sales Orders</a></li>
        	...
        	<div id="content">
            <h2 class="title"><span class="style7"><strong>sales orders</strong> / NEW</span></h2>
			<br>
            <div class="entry">
                <input name="b1" type="button" value="SAVE" onClick="document.location.href='newuser.jsp'">
            
            &nbsp; OR &nbsp;&nbsp; <a href="salesorder.jsp" class="style1"> DISCARD </a>
            </div>
            
            <br>
            <input name="b2" type="button" value="SEND BY EMAIL">&nbsp;
            <input name="b3" type="button" value="PRINT">&nbsp;
            <input name="b4" type="button" value="CONFIRM SALE" onClick="document.location.href='salesorder2.jsp'">&nbsp;
            <input name="b5" type="button" value="CANCEL" onClick="document.location.href='salesorder.jsp'">
            <br><br>
