    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li><a href="salesorder.jsp" class="style4">Sales Orders</a></li>
        	...
        	<div id="content">
            <div class="post">
            <h2 class="title"><strong>quotations</strong> / <span class="style5">q_Number</span></h2>
<div class="entry">
            ...
            <div class="post">
            <input name="b2" type="button" value="VIEW DELIEVERY ORDER" onclick="document.location.href='quot3.jsp'">
            &nbsp;
            <input name="b3" type="button" value="CREATE INVOICE">
            &nbsp;&nbsp;
            <input name="b5" type="button" value="CANCEL" onclick="document.location.href='quot1.jsp'">
            <br>
            </div>
...
<tr>
  ...
  <table width="810" height="86" border="0" cellpadding="5" bgcolor="#CCCCCC">
              ...
              <tr>
                ...
                <td width="96" class="style9">DATE:</td>
          ...
          <table>
      <tr align="center">  
      <td width="156" height="39" class="style7" bgcolor="#999999"><strong>PRODUCT
        </th>
      </strong>
      ...
      <td width="160" class="style9" bgcolor="#999999">SUBTOTAL</th>      </tr>
      </table>
      
  <table width="810" height="80"  border="0" bordercolor="#000000">
      
      <tr>
      <td width="156" height="18" bgcolor="#CCCCCC">&nbsp;</td>
      <td width="158" bgcolor="#CCCCCC">&nbsp;</td>
