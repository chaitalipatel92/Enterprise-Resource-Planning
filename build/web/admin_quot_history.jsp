       ...
       <div id="cssmenu">
		...
		<li><a href="admin_pur_order.jsp" class="style3">Purchase Orders</a></li>
		 <li class="current_page_item"><a href="admin_quot_history.jsp" class="style1 style2">Quotation History</a></li>
            ...
            <h2 class="title"><span class="style19">Quotations History</span></h2>
            <br>
            <br>
...
<strong>
 <%
                     ...
                     cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/home?zeroDateTimeBehavior=convertToNull","root","");
                     st  = cn.createStatement();
                     rs = st.executeQuery("select distinct sup_name from p_quotation");
                     out.print("<table border =1 width ='90%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
                        ...
                        while(rs.next())
                            ...
                            out.print("<td width = '100'> <a href ='admin_quot_viewDetail.jsp?x="+ sname +"'>fullDetail</a></td>");
                            out.print("<td width = '100'> <a href ='admin_quot_deleteData.jsp?x="+ sname +"'>Delete</a></td>");
                            out.print("</tr>");
