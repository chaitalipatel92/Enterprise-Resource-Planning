...
-->
	...
	<div id="header">
		<div id="menu">
			<ul>
                            ...
                            <li class="current_page_item"><a href="quot.jsp" class="first"><strong>Sales</strong></a></li>
    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li class="current_page_item"><a href="product.jsp" class="style4">Products</a></span></li>
		</ul>
      </div> 
        	<div id="content">
            <div class="post">
            ...
            <div class="entry">
                <input name="v1" type="button" value="create" onClick="document.location.href='product_add.jsp'">
