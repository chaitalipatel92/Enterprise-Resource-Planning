    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li class="current_page_item"><a href="po.jsp" class="style3">Purchase Order</a></li>
        	...
        	<div id="content">
            <div class="post">
            <h2 class="title"><strong>quotations</strong> /(P_ORDERNO)</h2>
  <input name="b1" type="button" value="SAVE" onClick="document.location.href='purquo2.jsp'">
  &nbsp; OR &nbsp;&nbsp; <a href="purchase1.jsp" class="style1"> DISCARD </a></div>
            <div class="post">&nbsp;
            <input name="b3" type="button" value="CANCLE ORDER">
            &nbsp;
            <input name="b4" type="button" value="RECIEVE PRODUCT" onClick="document.location.href='purquo3.jsp'">
            &nbsp;
            <input name="b5" type="button" onClick="document.location.href='p_invoice.jsp'" value="RECEIVE INVOICE">
            <br>
            </div>
...
<tr>
  ...
  <table width="808" border="0">
    <tr>
      <td height="57"><span class="style11"> REQUEST FOR QUOTATION /</span>
             &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;            
               <input name="b6" type="button" value="INCOMING SHIPMENTS">
                 &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
               <input name="b7" type="button" value="INVOICES">
      </td>
    </tr>
  </table>
  <table width="810" height="86" border="0" cellpadding="5" bgcolor="#CCCCCC">
          ...
          <table width="810" height="35" border="0">
            <tr>
              <td><span class="style9">PURCHASE ORDER:</span></td>
            </tr>
          </table>
  ...
  <table width="810" border="0">
    <tr>
      <td width="477" rowspan="3"><span class="style7">TERMS &amp; CONDITION</span></td>
