...
-->
    ...
    <br>
		...
		<ul>
                ...
                <li class="current_page_item"><a href="saled_products.jsp" class="style1 style2">Saled Products History</a></li>
		<li><a href="purchased_products.jsp" class="style3">Purchased Products History</a></li>
            ...
            <div class="post">
            <br>
            <h2 class="title"><span class="style19"><a href="saled_products.jsp" class="style5"><u>Saled products</u></a>/<span class="style21 style16">details</span></span></h2>
<div class="entry">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
