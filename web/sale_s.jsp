...
-->
	...
	<div id="header">
		<div id="menu">
			<ul>
                            ...
                            <li class="current_page_item"><a href="sale_s.jsp" class="first"><strong>Sales</strong></a></li>
    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li><a href="sales1.jsp">Customers</a></li>
		...
		<li><a href="product.jsp" class="style4">Products</a></span></li>
        	...
        	<div id="content">
            <div class="post">
            <h2 class="title"><strong>customers</strong></h2>
            <div class="entry">
                <input name="v1" type="button" value="create" onClick="document.location.href='sale1.jsp'">
