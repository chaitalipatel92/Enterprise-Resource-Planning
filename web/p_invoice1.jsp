    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li class="current_page_item"><a href="po.jsp" class="style3">Purchase Orders</a></li>
        	...
        	<div id="content">
            <div class="post">
            <h2 class="title"><strong>sales orders</strong>/(q_number)/invoice</h2>
<div class="entry">
            ...
            &nbsp;&nbsp;
            <input name="b4" type="button" value=" PAYMENT"  onClick="document.location.href='invoice1.jsp'">
            &nbsp;&nbsp;<br>
    </div>
...
<tr>
  ...
  <table width="810" height="82" border="0" cellpadding="5" bgcolor="#CCCCCC">
              ...
              <tr>
              <td height="30" colspan="2" class="style7"><strong>SOURCE DOCUMENT:</strong></td>
              <td width="351"><input type="text" name="t" value="" size="35" /></td>
                <td class="style9">DUE DATE::</td>
