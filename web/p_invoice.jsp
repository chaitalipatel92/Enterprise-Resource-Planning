       ...
       <div id="cssmenu">
		...
		<li class="current_page_item"><a href="po.jsp" class="style3">Purchase Orders</a></li>
            ...
            <h2 class="title"><span class="style7"><strong>sales orders</strong>/(q_number)/invoice</span></h2>
				<div class="post">
                <div class="entry">
                <input name="b1" type="button" value="EDIT">
          ...
          <input name="b3" type="button" value="VALIDATE" onClick="document.location.href='p_invoice1.jsp'">
            &nbsp;&nbsp;<br>
...
<tr>
  ...
  <table width="810" height="82" border="0" cellpadding="5" bgcolor="#CCCCCC">
              ...
              <tr>
               <td width="73" class="style7"><strong>SOURCE DOCUMENT:</strong></td>
                <td height="34" colspan="2"><input type="text" name="t3" value="" size="35" /></td>
