...
width: 250;}
     ...
     <script language ="JavaScript">
        ...
        {
           // alert(a1);
           location.href ="admin_pur_order2.jsp?id="+a1+"&supname="+supname;
        }                                                   
        
        function fun5(id,price,q1,date,total,spn)
        {
		              //location.href ="admin_pur_quot2.jsp?id="+pr1+"&price="+tprice+"&qty="+qty+"&pqty="+pqty+";
                              location.href ="admin_pur_order3.jsp?id="+id+"&price="+price+"&qty="+q1+"&date="+date+"&total="+total+"&supname="+spn+"";
		} 
        ...
        {
            var r = confirm("Are You Sure You Want To Place Order to "+supname+" ?");
                        if(r==true)
                            {
...
<br>
            ...
            <input name="b3" type="button" value="PRINT">&nbsp;<br>
            </p>
            <br>
...
<%= df.format(new java.util.Date()) %>">
      ...
      <td bgcolor="#999999" class="style10"><div align="center">PRICE
        </th>     
      </div>
      ...
      <td bgcolor="#999999" class="style10"><div align="center">SUBTOTAL
        </th>     
      </div>
      
      
      <td width="56" rowspan="2" bgcolor="#666666">
      <input name="a1" type="button" value="Add" onClick="fun5(pr1.value,price.value,qty2.value,date1.value,ts1.value,'<%=supname%>')">      </td> 
      </tr>
      <tr align="center">
        <td height="25" class="style7" bgcolor="#CCCCCC">
          ...
          %>
          <select name="pr1" id="pr1" onChange="fun1(this.value,'<%=supname%>')">
          <%
             while(rs.next())
                                {
			 	try{
        ...
        <td width="215" bgcolor="#CCCCCC" class="style9"><label></label>    
            <input type="text" name="price" id="price" value ='<%=price1%>' disabled>  
        
        <td width="188" bgcolor="#CCCCCC" class="style9"><label></label>    
        <input type="text" name="qty2" id="qty2" onBlur="fun2(this.value,price.value)" value ='<%=q1%>'>       
     
      
      <td width="215" bgcolor="#CCCCCC" class="style9"><label></label>    
            <input type="text" name="ts1" id="ts1"  value = "<%=totalamt%>" disabled>  
         </tr>
 ...
 <%
                    ...
                    try
                     ...
                     out.print("<table border =0 width ='100%' align ='center' bgcolor = '#FFFFFF'style='font-size:16px; color:#000000'> ");
                         ...
                         out.print("<th>Product</th><th>Price</th><th>Quantity</th><th>Subtotal</th><th></th>");
                         out.print ("</tr>");
                          ...
                          while(rs.next())
                            ...
                            out.print("<td> <a href ='ad_p_order_deleteData.jsp?x="+ id +"&supname="+supname+"'>Delete</a></td>");
                          ...
                          out.print("</table>");
                           ...
                           String sum="0";
                          st  = cn.createStatement();
                    rs = st.executeQuery("select sum(total) from temp2");
       ...
       %>  
            ...
            <br><br>
            <div align="center">
              <input name="a2" type="button" value="CONFIRM ORDER" onClick="fun6('<%=supname%>')">
				&nbsp;&nbsp;&nbsp;              
