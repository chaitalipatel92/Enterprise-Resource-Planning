   ...
   function cname(a1, a2)
    {
       ...
       if(x.length <=0)
           document.getElementById(a2).innerHTML = "<font color ='red' size=2>Client Name must be filed out !!</font>";
        else
...
<td width="682"><table width="722" height="484" border="0" align="center" bgcolor="#0166ff" class="style3">
          <tr>
            ...
            <tr>
              ...
              <td width="591"><input type="text" name="t1" size="40" id="cname" onBlur="cname(this,'p1')"/><span id="p1"></span></td>
            </tr>
...
<input type="submit" class="style3" value="SUBMIT"/>&nbsp;&nbsp;
              <label>
