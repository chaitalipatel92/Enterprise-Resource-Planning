    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li><a href="w_purchased_products.jsp" class="style3">Purchased Products History</a></li>
            ...
            <div class="post">
            <br>
            <h2 class="title style9"><em><strong>saled PRODUCTS</strong></em></h2>
            <div class="entry"></div>
...
<strong>
 <%
                     ...
                     cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/home?zeroDateTimeBehavior=convertToNull","root","");
                     st  = cn.createStatement();
                     rs = st.executeQuery("select distinct prod_name from s_order");
                     out.print("<table border =1 width ='90%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
                        ...
                        while(rs.next())
                            ...
                            out.print("<td width = '100'> <a href ='w_saled_viewDetail.jsp?x="+ pname +"'>fullDetail</a></td>");
                           out.print("</tr>");
