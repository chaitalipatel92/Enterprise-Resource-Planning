...
-->
    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li class="current_page_item"><a href="po.jsp" class="style3">Purchase Order</a></li>
		</ul>
      </div> 
        	<div id="content">
            <div class="post">
            <h2 class="title"><strong>Quotations/(p_ordernumber)</strong><strong>/in(0004)</strong></h2>
<div class="entry">
        ...
        <div class="post">&nbsp;
          <input name="b3" type="button" value="RECIEVE">
            &nbsp;&nbsp;
        <input name="b5" type="button" value="CANCEL" onClick="document.location.href='purquo2.jsp'">
            <br>
            </div>
...
<tr>
  ...
  <table width="808" border="0">
    <tr>
      <td height="57"><span class="style11">IN (0004)</span></td>
    </tr>
  </table>
  <table width="810" height="141" border="0" cellpadding="5" bgcolor="#CCCCCC">
             
              <tr>
                <td width="118" class="style7"><strong>SUPPLIER:</strong></td>
                <td height="32" colspan="2"><input type="text" name="t3" value="" size="35" /></td>
                <td width="102" class="style9">PURCHESE ORDER:</td>
                <td width="237"><input type="text" name="t4" value="" size="35" /></td>
              </tr>
              <tr>
                <td class="style7"><strong>STOCK JOURNAL:</strong></td>
                <td height="32" colspan="2"><input type="password" name="t1" value="" size="35" /></td>
                <td class="style9">TIME:</td>
                <td><input type="text" name="t2" value="" size="35" /></td>
              </tr>
              <tr>
              <td colspan="3" rowspan="2" class="style7">&nbsp;</td>
              <td height="32" class="style9">SCHEDULED TIME:</td>
                <td><input type="text" name="t5" value="" size="35" /></td>
      </tr>
              <tr>
                <td height="27" class="style9">SOURCE DOCUMENT:</td>
                <td>&nbsp;</td>
              </tr>
          </table>
...
<table width="810" height="35" border="0">
          ...
          <table>
      <tr align="center">  
      <td width="155" height="28" bgcolor="#999999" class="style7"><strong>PRODUCT
