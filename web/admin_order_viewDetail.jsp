    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li><a href="admin_pur_order.jsp" class="style3">Purchase Orders</a></li>
            ...
            <div class="post">
            <br>
            <h2 class="title"><span class="style19"><a href="admin_order_history.jsp" class="style5"><u>Order History</u></a>/<span class="style21 style16">details</span></span></h2>
<div class="entry">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <br><br><br>
          ...
          try
                     ...
                     cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/home?zeroDateTimeBehavior=convertToNull","root","");
                     st  = cn.createStatement();
                     rs = st.executeQuery("select * from p_order where sup_name = '"+ supname +"'");
                     ...
                     out.print("<table border =1 width ='90%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
						...
						out.print("<th colspan=5>Supplier Name &nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp "+ supname + "</th>");
                                                //out.print("<td colspan=4 align = 'center'>"+ supname + "</td>");
						 out.print ("</tr>");
                         out.print ("<tr bgcolor ='black' style = 'color:#FFFFFF'>");
                         out.print("<th>Date</th><th>Product Name</th><th>Price</th><th>Quantity</th><th>Total</th>");
