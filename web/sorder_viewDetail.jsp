    ...
    <br>
       ...
       <div id="cssmenu">
		...
		<li class="current_page_item"><a href="admin_sale_order.jsp" class="style3">Sales Orders</a></li>
            ...
            <div class="post">
            <br>
            <h2 class="title"><span class="style19"><a href="admin_sale_order.jsp" class="style5"><u>Sales Orders</u></a>/<span class="style21 style16">details</span></span></h2>
<div class="entry">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          try
                     ...
                     cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/home?zeroDateTimeBehavior=convertToNull","root","");
                     st  = cn.createStatement();
                     rs = st.executeQuery("select * from s_order where username = '"+ user +"'");
                     ...
                     out.print("<table border =1 width ='100%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
						...
						out.print("<th colspan=6>UserName &nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp"+ user + " </th>");
                                                //out.print("<td colspan=5 align = 'center'>"+ user + "</td>");
						 out.print ("</tr>");
                         out.print ("<tr bgcolor ='black' style = 'color:#FFFFFF'>");
                         out.print("<th>Date</th><th>Product Id</th><th>Product Name</th><th>UnitPrice</th><th>Quantity</th><th>Total</th>");
