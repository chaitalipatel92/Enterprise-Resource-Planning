...
-->
    ...
    <br>
       ...
       <div id="cssmenu">
		<ul>
        <li class="current_page_item"><a href="admin_sale_quot.jsp" class="style1 style2">Quotations</a></li>
		<li><a href="admin_sale_order.jsp" class="style3">Sales Orders</a></li>
            ...
            <div class="post">
            <br>
            <h2 class="title"><span class="style19"><a href="admin_sale_quot.jsp" class="style5"><u>Sales Quotations</u></a>/<span class="style21 style16">details</span></span></h2>
<div class="entry">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          try
                     ...
                     cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/home?zeroDateTimeBehavior=convertToNull","root","");
                     st  = cn.createStatement();
                     rs = st.executeQuery("select * from s_quotation where username = '"+ user +"'");
                     ...
                     out.print("<table border =1 width ='90%' align ='center' bgcolor = '#CCCCCC'style='font-size:16px; color:#000000'> ");
						...
						out.print("<th colspan=3>UserName &nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp "+ user + "</th>");
                                                //out.print("<td colspan=3 align = 'center'>"+ user + "</td>");
						 out.print ("</tr>");
                         out.print ("<tr bgcolor ='black' style = 'color:#FFFFFF'>");
                         out.print("<th>Date</th><th>Product Name</th><th>Price</th>");
                     ...
                     out.print("<tr>");
                    out.print("<td>Date :</td> <td>"+ rs.getString("date")+"</td>");
                     out.print("</tr>");
                     
                     out.print("<tr>");
                    out.print("<td>Product Id :</td> <td>"+ rs.getString("prod_id")+"</td>");
                     out.print("</tr>");
                     
                     out.print("<tr>");
                    out.print("<td>Product Name :</td> <td>"+ rs.getString("prod_name")+"</td>");
                     out.print("</tr>");
                     
                     out.print("<tr>");
                    out.print("<td>Price:</td> <td>"+ rs.getString("price")+"</td>");
                     out.print("</tr>");
